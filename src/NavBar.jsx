                ...
                <form className="max-w-md mx-auto">
                  <div className="relative">
                    ...
                    <input
                      type="search"
                      id="default-search"
                      className="block w-full p-3 ps-10 border-none text-sm rounded-lg bg-[#F5F4F6]"
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 flex flex-col justify-between">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Dashboard</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Assets</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Booking</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Sell Cars</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Buy Cars</span>
              </a>
            </li>
            <li>
              <NavLink
            ...
            <li>
              ...
              >
                <img src={one} />
                <span className="ms-3 text-[#5F6165]">Calendar</span>
              </a>
            </li>
            <li>
              <a
          ...
          <div className=" space-y-2">
            ...
            >
              <img src={one} />
              <span className="ms-3 text-[#5F6165]">Log Out</span>
            </a>
          </div>
        </div>
      </aside>
